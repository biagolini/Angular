...
[EN]: This repository serves as an index for various Angular-based projects and code examples. Each linked repository demonstrates different aspects of Angular development, including UI components, API integrations, form handling, table enhancements, and utility features. The goal is to provide practical examples that can be used as references for learning and development. For more in-depth discussions and technical articles, visit my LinkedIn and Medium profiles.

[PT]: Este repositório serve como um índice para diversos projetos e exemplos de código baseados em Angular. Cada repositório vinculado demonstra diferentes aspectos do desenvolvimento com Angular, incluindo componentes de UI, integrações com APIs, manipulação de formulários, melhorias em tabelas e funcionalidades útis. O objetivo é fornecer exemplos práticos que possam servir como referência para aprendizado e desenvolvimento. Para discussões mais aprofundadas e artigos técnicos, visite meus perfis no LinkedIn e no Medium.
...
### Button Toggle
Implementation of a button toggle component in Angular.

[https://github.com/biagolini/AngularButtonToggle](https://github.com/biagolini/AngularButtonToggle)
